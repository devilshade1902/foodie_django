...
from .views import restaurant_list,create_restaurant,Restaurant_delete,dish_delete,remove_from_cart,update_cart,create_order, payment_success,RestaurantUpdateView,MenuUpdateView
from .import views
